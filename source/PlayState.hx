...
class PlayState extends MusicBeatState
{
	...
	override public function create()
	{
		...
		switch(SONG.stage)
		{
			...
			{
					defaultCamZoom = 0.9;
					if (SONG.song.toLowerCase() == 'first-town' || SONG.song.toLowerCase() == 'liquated' || SONG.song.toLowerCase() == 'why-do-you-hate-me' || SONG.song.toLowerCase() == 'ghost')
					{
						defaultCamZoom = 0.5;
						curStage = 'camellia';
		...
		kadeEngineWatermark = new FlxText(4,healthBarBG.y + 50,0,StringTools.replace(SONG.song,"-", " ") + " " + (storyDifficulty == 2 ? "Hard" : storyDifficulty == 1 ? "Normal" : "Easy") + (Main.watermarks ? " - KE " + MainMenuState.kadeEngineVer : ""), 16);
